        ...
        <div class="row">
            <div id="sidebar" class="col-2">
                ...
                <form action="" method="POST" class="row ControlForms" target="NoReload">
                    ...
                    <div class="col-3"></div>
                    <input name="DR_ScanID" id='ScanID' type="submit" value="OFF" class="col-6 Fire_Apply">
                </form>
        		<div class="row Section_Separator"></div>
                <form action="" method="POST" class="row ControlForms" target="NoReload">
                    <p class="col-12">Iterations (K):</p>
                    <input type="text" name="DR_updIter" class="col-6 Input_Apply" placeholder="">
                    <input name="DR_updIterApp" type="submit" value="Apply" class="col-6 Button_Apply">
                </form>
        		<div class="row Section_Separator"></div>
                <form action="" method="POST" class="row ControlForms" target="NoReload">
                    <p class="col-12">Devices Number:</p>
                    <input type="text" name="DR_updNumb" class="col-6 Input_Apply" placeholder="">
                    <input name="DR_updNumbApply" type="submit" value="Apply" class="col-6 Button_Apply">
                </form>
        		<div class="row Section_Separator"></div>
                <div class="row">
            ...
            <canvas class="col-5 DisplayCanvas" id="Can_2"></canvas>
            <div class="col-5 DisplayCanvas" id="Can_3">
            </div>
        <div>
		<div class="row Section_Separator"></div>
